...
Where as in Feed forward Neural Networks such as MLPN's at time t for a input {$x$(f)}_{t\geq0}\\ output would be {f(w,x(t))}_{t\geq0},{\textbf{without regard to the previous history}}.
